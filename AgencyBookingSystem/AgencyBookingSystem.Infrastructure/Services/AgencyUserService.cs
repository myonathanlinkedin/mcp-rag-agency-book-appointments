...
public class AgencyUserService : IAgencyUserService
{
    ...
    public async Task SaveAsync(AgencyUser entity, CancellationToken cancellationToken = default) => await agencyUserRepository.UpsertAsync(entity, cancellationToken);
