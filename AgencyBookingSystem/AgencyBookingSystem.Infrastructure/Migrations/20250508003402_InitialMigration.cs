        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentSlots_Agencies_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Agencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Holidays_Agencies_AgencyId",
                        column: x => x.AgencyId,
                        principalTable: "Agencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AgencyUsers_AgencyUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AgencyUserId",
                table: "Appointments",
                column: "AgencyUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_AgencyId",
                table: "AppointmentSlots",
                column: "AgencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Holidays_AgencyId",
                table: "Holidays",
                column: "AgencyId");
        }
